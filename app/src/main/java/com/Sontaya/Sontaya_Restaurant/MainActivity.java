...
public class MainActivity extends AppCompatActivity {
    ...
    public class MySynJSON extends AsyncTask<Void, Void, String>{
        ...
        protected String doInBackground(Void... voids){
            try{
                String strURL = "http://www.csclub.ssru.ac.th/s56122201047/food/php_get_userTABLE.php";
                ...
                Log.d("Sontaya", "doInBack ==> " + e.toString());
                return null;
            }
        }
        ...
        protected void onPostExecute(String s){
            ...
            try{
                ...
                Log.d("Sontaya","onPost ==> " + e.toString());
            }
        }   //onPostExecute
    }   //MySynJSON
